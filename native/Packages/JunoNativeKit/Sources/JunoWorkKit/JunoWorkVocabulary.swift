...
public enum JunoWorkVocabulary {
    // MARK: - Tools
    ...
    public static func toolPresent(_ name: String?) -> String {
    ...
    public static func toolPast(_ name: String?) -> String {
    ...
    public static func terminalReason(_ reason: String?) -> String? {
    ...
    public static func artifactKind(_ kind: JunoWorkArtifactKind) -> String {
        switch kind {
    ...
    public static func artifactSymbol(_ kind: JunoWorkArtifactKind) -> String {
        switch kind {
    ...
    public static func target(_ raw: String?, hostName: String?) -> String {
    ...
    public static func risk(_ raw: String) -> String {
    ...
    public static func riskTint(_ raw: String) -> Color {
        switch JunoWorkRiskLevel(rawValue: raw) {
    ...
    /// learns its name.
    public static func sentenceCased(_ token: String) -> String {
        let words = token
