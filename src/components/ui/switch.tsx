...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SwitchPrimitives.Thumb className="pointer-events-none block size-4 translate-x-px rounded-full bg-card shadow-raised-lg ring-0 transition-transform duration-base ease-out-strong motion-reduce:transition-none data-[state=checked]:translate-x-[17px] dark:bg-foreground" />
  </SwitchPrimitives.Root>
));
