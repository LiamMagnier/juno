        ...
        <div className="space-y-4 p-5">
          <div>
            ...
            <div className="mt-1.5 flex flex-wrap items-center gap-x-1.5 gap-y-1 text-xs text-muted-foreground">
              ...
              {model.status === "legacy" && (
                <span className="rounded-full border border-border/70 px-1.5 py-px font-mono text-[9px] text-muted-foreground/80">
                  Legacy
                </span>
              )}
            </div>
          ...
          <div className="border-t border-dashed border-border/60 pt-3">
            <div className="mb-1 font-mono text-[10px] text-muted-foreground">Pricing</div>
            {free ? (
                  ...
                  return (
                    <div key={g.key} className="mb-4">
                      <div className="flex items-center gap-1.5 px-3 pb-2 pt-1">
                        ...
                        <span className="font-mono text-[10px] text-muted-foreground/80">{g.label}</span>
                      </div>
                            ...
                            <button type="button" onClick={() => select(AUTO_MODEL_INFO)} className="flex w-full items-start gap-2.5 text-left">
                              ...
                              <span className="min-w-0 flex-1">
                                <span className="flex items-center gap-1.5">
                                  ...
                                  <span className="rounded-full border border-primary/30 bg-primary/10 px-1.5 py-px text-[9px] font-semibold text-primary">
                                    Smart
                                  </span>
                                </span>
