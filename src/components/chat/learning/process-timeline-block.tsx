          ...
          return (
            <li key={index} className="relative">
              <button
                ...
                className={cn(
                  "grid w-full grid-cols-[2.5rem_minmax(0,1fr)] gap-x-4 rounded-control text-left",
              ...
              >
                ...
                <span className="flex justify-end pt-3">
                  <span
                    aria-hidden
                    className={cn(
                      "font-sans text-body font-medium leading-none tabular-nums transition-colors duration-base ease-out-soft",
                ...
                <span className="flex flex-col gap-1 py-3">
                  <span
                    className={cn(
                      "font-sans text-body font-semibold leading-6 transition-colors duration-base ease-out-soft",
