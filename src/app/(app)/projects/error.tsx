...
/**
 * /projects when the segment throws.
 *
...
export default function ProjectsError({
  ...
  React.useEffect(() => {
    console.error("[route] /projects failed to render", error);
  }, [error]);
  ...
  return (
    <AppPage measure="wide">
        <EmptyState
          ...
          description="The list didn’t come back. Every project, and everything filed in one, is still there."
          action={
            <>
