...
/**
 * /permissions/[hostId] when the segment throws.
 *
...
export default function HostPermissionsError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[route] /permissions/[hostId] failed to render", error);
  }, [error]);
  ...
  return (
    <AppPage measure="reading">
      <EmptyState
        ...
        title="This Mac couldn’t load"
        description="Nothing has been changed by the attempt: it still has whatever permissions it had, and this page not loading has not taken any of them away."
        action={
          <>
            ...
            <Button asChild size="sm" variant="outline">
              <Link href="/permissions">Back to permissions</Link>
            </Button>
          </>
        }
      />
