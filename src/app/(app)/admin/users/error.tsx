...
/**
 * /admin/users when the segment throws.
 *
...
export default function AdminUsersError({
  ...
  React.useEffect(() => {
    console.error("[route] /admin/users failed to render", error);
  }, [error]);
  ...
  return (
    ...
    <div>
      <EmptyState
        ...
        title="Couldn’t open the account list"
        description="The directory didn’t come back. No plan, role or ban has been changed by the attempt."
        action={
          <>
