...
/**
 * /code/new when the segment throws.
 *
...
export default function NewCodeSessionError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[route] /code/new failed to render", error);
  }, [error]);
  ...
  return (
    ...
    <AppPage measure="wide">
      <EmptyState
        ...
        description="The session composer didn’t come up. No run has been started, and any session already going is unaffected."
        action={
          <>
