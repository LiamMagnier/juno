...
/**
 * The pull-request list: one narrow column of rows under the page header.
 *
...
export default function CodePullsLoading() {
  return (
    ...
    <div className="app-page-scroll" role="status" aria-label="Loading pull requests">
      <div className="app-page-content max-w-2xl">
        ...
        <div className="space-y-2.5">
          {[...Array(4)].map((_, i) => (
            <Skeleton
              key={i}
              className="h-20 w-full rounded-field [animation-fill-mode:backwards] motion-safe:animate-rise-in"
