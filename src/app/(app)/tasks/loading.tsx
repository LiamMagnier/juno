...
/**
 * Three task cards at the height the real ones settle at.
 *
...
export default function TasksLoading() {
  return (
    ...
    <div className="app-page-scroll" role="status" aria-label="Loading scheduled tasks">
      <div className="app-page-content max-w-2xl">
        ...
        <div className="space-y-3">
          {[...Array(3)].map((_, i) => (
            <Skeleton
              key={i}
              className="h-[124px] w-full rounded-card [animation-fill-mode:backwards] motion-safe:animate-rise-in"
