...
/**
 * /profile when the segment throws.
 *
...
export default function ProfileError({
  ...
  React.useEffect(() => {
    console.error("[route] /profile failed to render", error);
  }, [error]);
    ...
    <div className="app-page-scroll">
      <div className="app-page-content mx-auto w-full max-w-3xl">
        <EmptyState
          ...
          description="Your activity, model mix and lifetime ledger all come from one request, and it didn’t come back. Your account itself is fine."
          action={
            <>
