...
/**
 * The connector directory: a three-column grid of equal tiles.
 *
...
export default function ConnectionsLoading() {
  return (
    ...
    <div className="app-page-scroll" role="status" aria-label="Loading connections">
      <div className="app-page-content max-w-5xl">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <Skeleton
              key={i}
              className="h-[132px] w-full rounded-card [animation-fill-mode:backwards] motion-safe:animate-rise-in"
