...
/**
 * /work/schedules/new when the segment throws.
 *
...
export default function NewWorkScheduleError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[route] /work/schedules/new failed to render", error);
  }, [error]);
  ...
  return (
    <AppPage measure="reading">
      <EmptyState
        ...
        title="The schedule editor couldn’t open"
        description="Nothing has been created. Your existing schedules are untouched and still running."
        action={
          <>
