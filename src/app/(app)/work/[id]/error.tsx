...
/**
 * /work/[id] when the segment throws.
 *
...
export default function WorkThreadError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[route] /work/[id] failed to render", error);
  }, [error]);
    ...
    <div className="app-page-scroll">
      <div className="app-page-content max-w-2xl">
        <EmptyState
          ...
          title="This task couldn’t load"
          description="The thread didn’t come back. The task itself is untouched — if it was running, it still is."
          action={
            <>
