...
export default function WorkError({
  ...
  React.useEffect(() => {
    console.error("[route] /work failed to render", error);
  }, [error]);
    ...
    <div className="app-page-scroll">
      <div className="app-page-content max-w-3xl">
        <EmptyState
          ...
          title="Couldn’t open Juno Work"
          description="Your tasks didn’t come back. Anything already running is still running — this page not loading has not stopped it."
          action={
            <>
