...
/**
 * /work/hosts/[id] when the segment throws.
 *
...
export default function WorkHostError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[route] /work/hosts/[id] failed to render", error);
  }, [error]);
        ...
        action={
          <>
            ...
            <Button asChild size="sm" variant="outline">
              <Link href="/work/permissions">Back to permissions</Link>
            </Button>
          </>
        }
      />
