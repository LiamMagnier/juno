...
/**
 * Name, one-line description, the long instructions box, then provenance.
 *
...
export default function NewWorkSkillLoading() {
  return (
    ...
    <div className="app-page-scroll" role="status" aria-label="Loading the skill editor">
      <div className="app-page-content max-w-3xl">
        ...
        <div className="space-y-5">
          ...
          <Skeleton className="h-9 w-56 rounded-field" />
        </div>
      </div>
    </div>
  );
