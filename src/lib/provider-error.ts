...
const BILLING = /balance|insufficient|recharge|billing|arrearage|(?:out of|no|any|zero|without)\s+(?:remaining\s+)?credits?|credit.{0,20}too low|exceeded your current quota|quota.{0,20}exceed|余额|充值/i;
