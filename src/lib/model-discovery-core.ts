...
export const FAMILIES: Partial<Record<Provider, Family[]>> = {
  ...
  openai: [
    ...
    { label: "GPT-5.2 Pro", match: /^gpt-5\.2-pro/i, minPlan: "PRO", vision: true },
    { label: "GPT-5.2 Codex", match: /^gpt-5\.2-codex/i, minPlan: "PRO", vision: true },
    { label: "GPT-5.2", match: /^gpt-5\.2(?!-)/i, minPlan: "PRO", vision: true },
    { label: "GPT-5.1 Codex Mini", match: /^gpt-5\.1-codex-mini/i, minPlan: "FREE", vision: true },
    { label: "GPT-5.1 Codex", match: /^gpt-5\.1-codex(?!-mini)/i, minPlan: "PRO", vision: true },
    { label: "GPT-5.1", match: /^gpt-5\.1(?!-)/i, minPlan: "PRO", vision: true },
  ...
  meta: [
    { label: "Llama 4 Maverick", match: /^llama-4-maverick/i, minPlan: "PRO", vision: true },
    { label: "Llama 4 Scout", match: /^llama-4-scout/i, minPlan: "FREE", vision: true },
    { label: "Llama 3.3 70B", match: /^llama-3\.3-70b/i, minPlan: "FREE", vision: false },
  ],
  zhipu: [
    { label: "GLM Vision FlashX", match: /^glm-[\d.]+v-flashx$/i, minPlan: "FREE", vision: true },
    { label: "GLM Vision Flash", match: /^glm-[\d.]+v-flash$/i, minPlan: "FREE", vision: true },
    { label: "GLM FlashX", match: /glm-[\d.]+-flashx/i, minPlan: "FREE", vision: false },
    { label: "GLM Flash", match: /glm-[\d.]+-flash(?!x)/i, minPlan: "FREE", vision: false },
    { label: "GLM AirX", match: /^glm-[\d.]+-airx$/i, minPlan: "FREE", vision: false },
    ...
    { label: "GLM 32B", match: /^glm-4-32b/i, minPlan: "FREE", vision: false },
    { label: "GLM X", match: /^glm-[\d.]+-x$/i, minPlan: "PRO", vision: false },
  ...
  mistral: [
    ...
    { label: "Ministral 8B", match: /^ministral-8b/i, minPlan: "FREE", vision: false },
  ...
  qwen: [
    ...
    { label: "Qwen 3.6 Plus", match: /^qwen3\.6-plus/i, minPlan: "PRO", vision: true },
    { label: "Qwen Long", match: /^qwen-long/i, minPlan: "PRO", vision: false },
    ...
    { label: "Qwen Plus", match: /qwen[\d.]*-plus/i, minPlan: "PRO", vision: true },
    { label: "Qwen Flash", match: /qwen[\d.]*-flash/i, minPlan: "FREE", vision: true },
