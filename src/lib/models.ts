...
const CURATED: ModelInfo[] = [
  ...
  def({ provider: "openai", id: "gpt-5.2", name: "GPT-5.2", family: "gpt", status: "legacy", minPlan: "PRO", vision: true, cost: 2, contextWindow: 400_000, description: "Previous frontier GPT model with configurable reasoning." }),
  def({ provider: "openai", id: "gpt-5.2-pro", name: "GPT-5.2 Pro", family: "gpt-pro", status: "legacy", minPlan: "PRO", vision: true, cost: 3, contextWindow: 400_000, comingSoon: true, description: "Previous Responses-only Pro model — disabled until Juno adds a Responses API adapter." }),
  def({ provider: "openai", id: "gpt-5.2-codex", name: "GPT-5.2 Codex", family: "gpt-codex", status: "deprecated", minPlan: "PRO", vision: true, reasoning: true, cost: 2, contextWindow: 400_000, description: "Older Codex-tuned model.", deprecationNote: "Deprecated by OpenAI — use GPT-5.3 Codex" }),
  def({ provider: "openai", id: "gpt-5.1", name: "GPT-5.1", family: "gpt", status: "legacy", minPlan: "PRO", vision: true, cost: 2, contextWindow: 400_000, description: "Previous coding and agentic GPT model with configurable reasoning." }),
  def({ provider: "openai", id: "gpt-5.1-codex", name: "GPT-5.1 Codex", family: "gpt-codex", status: "deprecated", minPlan: "PRO", vision: true, reasoning: true, cost: 2, contextWindow: 400_000, comingSoon: true, description: "Responses-only Codex model — disabled until Juno adds a Responses API adapter.", deprecationNote: "Deprecated by OpenAI — use GPT-5.3 Codex" }),
  def({ provider: "openai", id: "gpt-5.1-codex-mini", name: "GPT-5.1 Codex Mini", family: "gpt-codex-mini", status: "deprecated", minPlan: "FREE", vision: true, reasoning: true, cost: 1, contextWindow: 400_000, description: "Older small Codex model.", deprecationNote: "Deprecated by OpenAI — use GPT-5.4 Mini" }),
...
const GENERATIVE: ModelInfo[] = [
  ...
  def({ provider: "seedance", id: "seedance-1-0-pro-fast-251015", name: "Seedance 1.0 Pro Fast", family: "seedance-fast", status: "legacy", modality: "video", minPlan: "MAX", cost: 2, description: "Faster, cheaper Seedance 1.0 Pro tier — silent video." }),
